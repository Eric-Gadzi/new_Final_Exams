        ...
        <div class="col-sm-6 login-section-wrapper">
          ...
          <div class="login-wrapper my-auto">
            ...
            <form method="POST" action="validate_Login.php">
              ...
              <button type="submit" class="btn btn-block login-btn" name="login" id="login" > Submit </button>
            </form>
            
            <a href="#!" class="forgot-password-link">Forgot password?</a>
            <p class="login-wrapper-footer-text">Don't have an account? <a href="/Final Exams/Pages/SignUp/SignUp.html" class="text-reset">Register here</a></p>
          </div>
        </div>
